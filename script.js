...
/* ═══════════════════════════════════════════════════════
   INTRO CONTROLLER
   Orquesta la secuencia cinematográfica completa.
   IIFE independiente — no contamina el scope global.
═══════════════════════════════════════════════════════ */
(function IntroController() {
  ...
  /* Si no existe el elemento, salir sin romper nada */
  if (!screen) return;
  ...
  function playSequence() {
    ...
    setTimeout(() => { if (canvas) canvas.classList.add('intro-visible'); }, 80);
